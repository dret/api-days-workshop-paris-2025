...
- 14.45-15.00: [Exercise 1 - Designing and Creating an API](#exercise-1)
- 15.00-15.10: [Exercise 2 - Validating OpenAPI](#exercise-2)
- 15.10-15.30: [API Linting](http://dret.net/lectures/api-days-paris-2025/workshop-linting)
- 15.30-15.45: [Exercise 3 - Linting OpenAPI](#exercise-3)
...
- 16.50-17.05: [Exercise 4 - Scoring and Improving OpenAPI](#exercise-4)
- 17.05-17.20: [API Description Pipelines with Overlays](http://dret.net/lectures/api-days-paris-2025/workshop-overlays)
- 17.20-17.30: [Exercise 5 - Tweaking OpenAPI](#exercise-5)
...
Let's validate that our APIs have no errors by loading them in either [Swagger Editor](https://editor.swagger.io) or [Scalar Editor](https://editor.scalar.com/).
...
The easiest way is to use [Scalar](https://scalar.com/)'s [web-based editor](https://editor.scalar.com/). Go to the "Diagnostic Rules" tab in the editing window, this is where you can paste in Spectral rules. This way you can easily test Spectral rules without having to install any software on your machine.

If you want to install Spectral, check out the [installation instructions](https://docs.stoplight.io/docs/spectral/b8391e051b7d8-installation), and then lint your API using the Spectral CLI:
...
Take your API and pasted it into the left hand column in [Speakeasy\'s Overlay Playground](https://overlay.speakeasy.com/). Now get the Overlay file in [exercise-4](./exercise-5/remove-purchase-endpoint.overlay.yaml) and paste it into the Overlay column (right hand side). Review the changes in the central column.
